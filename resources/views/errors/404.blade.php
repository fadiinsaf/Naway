...
<head>
    <meta charset="UTF-8">
    <title>404 - Lost in the Scales | Naway</title>
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-md w-full">
            <div class="mb-6 text-primary">
                <i class="fa-solid fa-music text-8xl animate-pulse"></i>
            </div>
            
            <h1 class="text-9xl font-bold text-accent dark:text-soft opacity-20 mb-4 tracking-widest">404</h1>
            
            <h2 class="text-3xl font-bold text-accent dark:text-soft mb-3">Lost in the Scales</h2>
            <p class="text-accent/70 dark:text-soft/70 leading-relaxed mb-8">
                The melody you are looking for has slipped out of tune. We couldn't find the requested page.
            </p>
