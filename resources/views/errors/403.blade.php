...
<head>
    <meta charset="UTF-8">
    <title>403 - Off-Key Permission | Naway</title>
...
<body class="flex flex-col min-h-screen bg-soft dark:bg-darkbg text-accent dark:text-soft antialiased font-sans">
    <div class="flex-1 flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
        <div class="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-yellow-500/20 dark:bg-yellow-500/10 rounded-full blur-3xl pointer-events-none z-0"></div>
        ...
        <div class="relative z-10 max-w-md w-full">
            ...
            <h1 class="text-9xl font-bold text-accent dark:text-soft opacity-20 mb-4 tracking-widest">403</h1>
            
            <h2 class="text-3xl font-bold text-accent dark:text-soft mb-3">Off-Key Permission</h2>
            <p class="text-accent/70 dark:text-soft/70 leading-relaxed mb-8">
                You are trying to play a rhythm you don't have access to. This area is restricted.
            </p>
            ...
            <div class="flex justify-center gap-4">
                ...
                <button onclick="history.back()" class="px-6 py-3 bg-white dark:bg-black/20 border border-primary/20 text-accent dark:text-soft font-semibold rounded-xl hover:bg-primary/5 dark:hover:bg-black/30 transition transform hover:-translate-y-0.5">
